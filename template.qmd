...
adipiscing elit [@Hirt1974]. Ut purus elit, vestibulum ut, placerat ac,
...
[@Liska2010]. Maecenas lacinia. Nam ipsum ligula, eleifend at, accumsan nec,
...
[@Taylor1937], text [@Knupp1999; @Kamm2000] inserted in text for your
reference.

Quisque ullamcorper placerat ipsum. Cras nibh [@Kucharik2003; @Blanchard2015].
...
diam. (Figure [-@fig-fig1] and [-@fig-fig2]) Aliquam pellentesque, augue quis
...
![This is the sample figure caption.](empty){#fig-fig2 fig-pos='t' width="342pt" height='9pc'}
...
> This is an example [@Burton2013;@Berndt2011;@Kucharik2012] for quote text.
This is an example for quote text. This is an example for quote text. This is an
example for quote text [@Breil2015]. This is an example for quote text. This is
an example for quote text. This is an example for quote text. This is an example
for quote text. This is an example for quote text. This is an example for quote
text [@Barth1997]. This is an example for quote text. This is an example for
quote text. This is an example for quote text.
...
Below is the example [@Liska2010; @Kucharik2003; @Blanchard2015] for bulleted
...
-->
- bulleted list entry sample bulleted list entry [@Lauritzen2011], sample list entry text.

- bulleted list entry sample bulleted list entry. bulleted list entry sample bulleted list entry. bulleted list entry sample bulleted list entry.

- bulleted list entry sample bulleted list entry [@Klima2017], bulleted list entry sample bulleted list entry [@Dukowicz2000], sample list entry text.  bulleted list entry sample bulleted list entry.
...
: description text, description text [@Kucharik2011;@Kucharik2014;@Loubere2005]. description text, description text, description text, description text, description text.
...
Pellentesque wisi. [@Kucharik2012] Nullam malesuada. Morbi ut tellus ut pede
...
justo, laoreet vitae, fringilla at, adipiscing ut, nibh. Maecenas non sem quis
tortor eleifend fermentum. Etiam id tortor ac mauris porta vulputate. Integer
porta neque vitae massa [@Hirt1974;@Benson1992].  Maecenas tempus libero a
...
Vivamus est. Morbi a tellus eget pede tristique commodo [@Benson1992]. Nulla
...
This is acknowledgment text. [@Kenamond2013] Provide text here.
This is acknowledgment text. Provide text here. This is acknowledgment text.
...
acknowledgment text. Provide text here. This is acknowledgment text.
Provide text here.
...
\vspace*{12pt}
Using the package `listings` you can add non-formatted text as you would do with `\begin{verbatim}` but its main aim is to include the source code of any programming language within your document.`\newline` Use `\begin{lstlisting}...\end{lstlisting}` for program codes without mathematics.

The `listings` package supports all the most common languages and it is highly customizable. If you just want to write code within your document, the package provides the `lstlisting` environment; the output will be in Computer Modern typewriter font. Refer to the below example:
...
euismod nunc eu purus. Donec bibendum quam in tellus. Nullam cursus pulvinar
lectus. Donec et mi. Nam vulputate metus eu enim. Vestibulum pellentesque felis
eu massa. Nulla malesuada porttitor diam. Donec felis erat, congue non, volutpat
